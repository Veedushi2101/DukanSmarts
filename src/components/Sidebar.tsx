      ...
      <div className="p-4 space-y-6 overflow-y-auto">
        ...
        <div className="flex items-center gap-3 px-2">
          ...
          <div>
            ...
            <p className="text-[10px] text-slate-400 font-medium">Rajesh Kirana Store</p>
          </div>
        </div>
      ...
      <div className="p-4 border-t border-slate-800/80 bg-slate-950/40">
        <div className="flex items-center gap-3 px-1">
          ...
          <div className="text-left overflow-hidden">
            <p className="text-xs font-bold text-white truncate">Rajesh Kumar</p>
            <p className="text-[10px] text-slate-400 truncate">Shop Owner • Indiranagar</p>
          </div>
        </div>
      </div>
    </aside>
